$(function () {
	var verify = {
		urls: {
			create_application: applicationBaseUrl + '/portal/workflow/doCreateApplication',
			update_application: applicationBaseUrl + '/portal/workflow/doUpdateApplication',
		},
		constants: {},
		variables: {},
		init: function () {
		...
		cacheDom: function () {
			...
			this.$createApplicationForm = $('#frm_workflow_create_app');
			this.$saveApplicationActionBtn = this.$createApplicationForm.find('#btn_save_application');

			//Create New Application Form
			this.$updateApplicationForm = $('#frm_workflow_update_app');
