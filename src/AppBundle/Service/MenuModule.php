...
class MenuModule
{
    ...
    public function getRcml($input = null)
    {
        ...
        $node->addAttribute('action', htmlentities($this->container->getParameter('application_url').'/restcomm/'.$this->moduleInstance->getAdapter()->getAdapterId().'/getNext?stepId=' . $this->moduleInstance->getModuleInstanceId().'&rand='.rand(100,99999)));
