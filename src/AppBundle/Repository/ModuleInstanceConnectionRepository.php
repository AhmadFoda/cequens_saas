...
class ModuleInstanceConnectionRepository extends EntityRepository
{
	/**
	 ...
	 * @return array
	 */
	public function getModuleInstanceConnections($moduleInstance)
	{
		$result   = [];
	 ...
	 * ]
	 */
	public function getModuleInstanceConnectionsWithInformation($moduleInstance)
	{
		$result           = [];
		$connectionTarget = [];
		...
		foreach ($instanceSettings as $setting) {
			$targetModuleInstance = $setting->getTargetModuleInstanceId();
			$connectionId         = $setting->getModuleInstanceConnectionId();
			$conditionType        = $setting->getConditionType();
			$conditionKey         = $setting->getConditionKey();
			$conditionValue       = $setting->getConditionValue();
			$connectionTarget[]   = ['conditionValue'=>$conditionValue, 'conditionTarget'=>$targetModuleInstance];
			$result   = ['type' => $conditionType, 'target' => $connectionTarget];
	 ...
	 */
	public function saveMultipleModuleInstanceConnection(ModuleInstance $moduleInstance, $moduleSettingId, $attributes, EntityManager $entityManager)
	{
		try {
	 ...
	 * @return ModuleInstanceSetting
	 */
	public function saveModuleInstanceConnection(ModuleInstance $moduleInstance, $moduleSettingId, $attribute, EntityManager $entityManager, $isSelect)
	{
