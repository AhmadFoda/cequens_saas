 ...
 */
class Version20180415121822 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, application_name VARCHAR(255) NOT NULL, application_description LONGTEXT NOT NULL, application_type INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, user_id INT NOT NULL, application_token LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE application_property (id INT AUTO_INCREMENT NOT NULL, application_id INT NOT NULL, property_id INT NOT NULL, property_value LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE property (id INT AUTO_INCREMENT NOT NULL, property_group_id INT NOT NULL, property_name VARCHAR(255) NOT NULL, property_display_name VARCHAR(255) NOT NULL, property_type INT NOT NULL, property_default_value VARCHAR(255) NOT NULL, property_is_required INT NOT NULL, property_created_at DATETIME NOT NULL, property_updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property_group (id INT AUTO_INCREMENT NOT NULL, property_group_name VARCHAR(255) NOT NULL, property_group_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE property_option (id INT AUTO_INCREMENT NOT NULL, property_id INT NOT NULL, property_option_name VARCHAR(255) NOT NULL, property_option_value VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE application_property');
